...
use App\Services\PortraitUploader;
...
{
    /**
     * @Route("/eve_online", name="oauth")
     */
    public function eve(CapsulerRepository $capsulerRepository)
    {   
        ...
        return $this->redirect($provider->getAuthorizationUrl($options));
    }
    ...
    */
    ...
    {
        return new JsonResponse('Ok je suis log');
    }
